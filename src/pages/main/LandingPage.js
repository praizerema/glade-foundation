  ...
  return (
    <div className="relative">
      ...
      <section id="about">
        ...
        <h2 className="text-3xl text-[#0E8427] text-bolder mb-3"> COVID almost shut down the world</h2>
        <h3 className="text-2xl text-[#0E8427] text-bolder mb-3"> Glade Foundation is saving the world starting with you</h3>
          <p>
            ...
            negatively affected.
            A lot of people have suffered financial loss, lost their means of living.
            Some are out of school, while some cannot afford hospital bills.
            Hence why we are here to do our bit in ensuring that these set of people get the financial help they need.

          </p>
        </div>
        <div className="grid md:grid-cols-2 gap-x-20 gap-y-10 top-1/2 relative px-8 sm:px-0">
          <div className="col-span-1 text-3xl md:text-5xl text-[700] text-center md:text-left text-[#0E8427] lg:pl-32 py-10">
          We cannot bring the world back alone. We ask you to partner with us as we save the world.
          </div>
